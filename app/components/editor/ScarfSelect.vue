<template>
    <div class="container">
        ...
        <div class="recommendation">
            Recommended scarf length for {{ robeColor }} Robe in {{ levelNames[levelValue + 1] }} is
            {{ recommendation }}
        </div>
    </div>
</template>
    ...
    methods: {
        ...
        updateRecommendation() {
            const recommendationsToUse =
                this.scarfRule === 0 ? this.redScarfRecommendations1 : this.redScarfRecommendations2;
            const lvl =
                this.levelValue >= recommendationsToUse.length ? recommendationsToUse.length - 1 : this.levelValue;
